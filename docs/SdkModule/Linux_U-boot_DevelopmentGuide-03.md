...
2. 开{LICHEE_CHIP}_defconfig或{LICHEE_CHIP}_nor_defconfig后，在相应的宏定义前去掉或添加"#"即可将相应功能开启或关闭。如下图，只要将CONFIG_SUNXI_NAND前的#去掉即可支持 NAND 相关功能，其他宏定义的开启关闭也类似。修改后需要运行make xxx_defconfig使修改后的配置生效。
   ...
   ![](https://photos.100ask.net/Tina-Sdk/LinuxU-bootDevelopmentGuide_001.png)
...
![](https://photos.100ask.net/Tina-Sdk/LinuxU-bootDevelopmentGuide_002.png)
...
![](https://photos.100ask.net/Tina-Sdk/LinuxU-bootDevelopmentGuide_003.png)
