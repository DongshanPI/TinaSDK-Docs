...
![图8-1: defconfig配置图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-1.jpg)
...
![图8-2: defconfig基本宏定义介绍图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-2.jpg)
...
![图8-3: menuconfig配置菜单图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-3.jpg)
...
![图8-4: sysconfig.fex基本结构图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-4.jpg)
...
![图8-5: platform配置图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-5.jpg)
...
![图8-6: target配置图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-6.jpg)
...
![图8-7: uart_para配置图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-7.jpg)
...
![图8-8: uboot启动调用环境变量方式图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-8.jpg)
...
![图8-9: kernel cmdline图](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-8-9.jpg)
...
![图9-1: TinaLinux内核配置菜单](https://photos.100ask.net/Tina-Sdk/OpenRemoved_Tina_Linux_System_software_development_Guide-9-1.jpg)